/**
 * Property validation schemas using Zod 4.x
 * @module domain/property/validations/property
 */
...
export const propertySchema = z
  .object({
    ...
    descricao: z
      ...
      .nullable()
      .optional(),
    usuario_cadastro: z.string('Usuário é obrigatório').min(1, 'Usuário não pode estar vazio'),
  })
  .refine(
    (data) => {
